...
|--------|------|
| `0`（默认） | 307/308 使用 GET |
| `ReqPost` | 307/308 使用 POST |
| `ReqGet` | 307/308 使用 GET |
| `ReqPut` | 307/308 使用 PUT |
| `ReqDelete` | 307/308 使用 DELETE |
| `ReqOptions` | 307/308 使用 OPTIONS |
...
| 307 | 保持原方法 | 默认 GET，可通过参数指定方法 |
| 308 | 保持原方法 | 默认 GET，可通过参数指定方法 |
